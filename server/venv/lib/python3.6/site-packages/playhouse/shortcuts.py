...
def model_to_dict(model, recurse=True, backrefs=False, only=None,
    ...
    """
    Convert a workbench_model instance (and any related objects) to a dictionary.
    ...
    :param list extra_attrs: Names of workbench_model instance attributes or methods
        that should be included.
    :param SelectQuery fields_from_query: Query that was source of workbench_model. Take
...
def update_model_from_dict(instance, data, ignore_unknown=False):
    ...
    for key, value in data.items():
        if key in meta.combined:
            ...
            raise AttributeError('Unrecognized attribute "%s" for workbench_model '
