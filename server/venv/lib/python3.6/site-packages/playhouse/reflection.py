...
class Column(object):
    ...
    def get_field_parameters(self):
        ...
        if self.is_foreign_key():
            params['workbench_model'] = self.rel_model
            if self.to_field:
...
class Introspector(object):
    ...
    def introspect(self, table_names=None, literal_column_names=False,
        ...
        # Store a mapping of table name -> workbench_model name.
        model_names = {}
            ...
            for column_name, column in columns.items():
                ...
                if column.is_foreign_key():
                    if column.is_self_referential_fk():
                        params['workbench_model'] = 'self'
                    else:
                        dest_table = column.foreign_key.dest_table
                        params['workbench_model'] = models[dest_table]
                    if column.to_field:
